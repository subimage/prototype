...
suite("Object Namespace",function(){
  ...
  test("Object.keys()", function() {
    assertenum([], Object.keys({}));
    assertenum(['bar', 'foo'], Object.keys({foo: 'foo', bar: 'bar'}).sort());
    function Foo() { this.bar = 'bar'; }
    Foo.prototype.foo = 'foo';
    assertenum(['bar'], Object.keys(new Foo()));
    assert.throws(function(){ Object.keys() },TypeError);
  ...
  test("Object.inspect()", function() {
    ...
    assert.doesNotThrow(function() { Object.inspect(window.Node) });
  });

  test("Object.toJSON()", function() {
  ...
  // sanity check
  test("Doesn't Extend Object Prototype", function() {
